class IcloudpdRs < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/rhoopr/icloudpd-rs/releases/download/v0.4.1/icloudpd-rs-macos-aarch64.tar.gz"
      sha256 "a7cb7316fda93a3df4cd38bc77d50aa1e4a8d5fdd7b16873dd0c9cfda709062d"
    else
