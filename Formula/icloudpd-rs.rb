class IcloudpdRs < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/rhoopr/icloudpd-rs/releases/download/v0.2.1/icloudpd-rs-macos-aarch64.tar.gz"
      sha256 "988a8c4b5d63a9ba4523cb37ff672ca4dbacc50d445fafcbf1153fcee99fcb78"
    else
